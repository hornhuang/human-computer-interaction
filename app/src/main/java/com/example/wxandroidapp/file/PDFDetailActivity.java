...
//        displayFromFile1("https://staticzcjb.weibangong.com/pdf/business_license.pdf", "business_license.pdf");
...
public class PDFDetailActivity extends AppCompatActivity {
    ...
    private String fileUrl = "https://staticzcjb.weibangong.com/pdf/business_license.pdf";
    ...
    private void initView() {
        ...
        mWebView.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                Toast.makeText(PDFDetailActivity.this, "开始请求pdf文件", Toast.LENGTH_SHORT).show();
            }
