package com.example.wxandroidapp.music.service;
...
import com.example.wxandroidapp.MainActivity;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    private void initMusicDatas(Intent intent) {
        ...
        List<MusicData> musicDatas = (List<MusicData>) intent.getSerializableExtra(ShareMusicActivity.PARAM_MUSIC_LIST);
