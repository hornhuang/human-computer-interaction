package com.example.wxandroidapp.music.activity;
...
import com.example.wxandroidapp.music.model.MusicData;
import com.example.wxandroidapp.music.service.MusicService;
import com.example.wxandroidapp.music.utils.DisplayUtil;
import com.example.wxandroidapp.music.utils.FastBlurUtil;
import com.example.wxandroidapp.music.widget.BackgourndAnimationRelativeLayout;
import com.example.wxandroidapp.music.widget.DiscView;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.example.wxandroidapp.music.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;


public class ShareMusicActivity extends AppCompatActivity implements DiscView.IPlayInfo, View
        .OnClickListener {
    ...
    private Drawable getForegroundDrawable(int musicPicRes) {
        ...
        final float widthHeightSize = (float) (DisplayUtil.getScreenWidth(ShareMusicActivity.this)
